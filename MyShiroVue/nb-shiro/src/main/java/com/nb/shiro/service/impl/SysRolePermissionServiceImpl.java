...
public class SysRolePermissionServiceImpl extends ServiceImpl<SysRolePermissionMapper, SysRolePermission> implements SysRolePermissionService {
    ...
    @Override
    public void saveRolePermission(String roleId, List<String> lastPermissionIds, List<String> newPermissionIds) {

        List<String> lastPermissionIdArray = lastPermissionIds;

        List<String> newPermissionIdsArray = newPermissionIds;
